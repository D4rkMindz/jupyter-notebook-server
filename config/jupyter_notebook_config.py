...
key = getenv('SSL_KEY')
if cert and cert.lower() != "disabled" and key and key.lower() != "disabled":
    c.ServerApp.certfile = getenv('SSL_CERT')
    c.ServerApp.keyfile = getenv('SSL_KEY')
# Set ip to '*' to bind on all interfaces (ips) for the public server
c.ServerApp.ip = '*'
c.PasswordIdentityProvider.hashed_password = u'argon2:$argon2i$v=19$m=16,t=2,p=1$aHNsdWFpbWw$2WuhdvQ+Bg+ISMDQVGI05A'
